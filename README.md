...
## Website features with user stories

Desktop view (1920x1080 resolution)

**User story:** To ensure the game is playable across all devices, I have implemented a mobile-first approach and designed the UI for different screen sizes.

**User story:** To ensure a user-friendly and inviting interface I have implemented common design patterns ([Tidwell, Brewer & Valencia, 2020](#credits)) and selected colours and fonts to match the game theme.

_The desktop view of the website_

![The desktop view of the website](./docs/images/desktop_view.png)

_The website on different devices_

![An image of the website on different devices](./docs/images/responsivity_image_small.png)

**User story:** An informative text provides details about the game.

_The header with the title and the introduction text to the game_

![An image of the introduction section with the header](./docs/images/introduction.png)

**User story:** High-quality images help users/players find matching pairs.

_An image of the game table with the duck images, generated by ChatGPT_

![An image of the game table with duck images generated by ChatGPT](./docs/images/duck_images.png)

**User story:** A restart button that resets the game.

**User story:** A score counter tracks the number of moves made by the user.

_There is a restart button which resets the game and a scorecounter to count +1 everytime two cards have been turned._

![An image of the score counting and the restart button](./docs/images/score_section.png)

**User story:** There is a button which opens a modal with instructions on how to play the game.

_To read the instructions on how to play, the How to play button can be clicked and a modal appears with the instructions._
...
| [GitHub](https://www.gitpod.io/)                                             | Version control and deployment | Tool                          | Used to create repository, version control and deployment.            |
...
| Source                                      | Location | Type    | Notes                                                      |
| ------------------------------------------- | :------- | :------ | :--------------------------------------------------------- |
| [Bootstrap](https://getbootstrap.com/)      | Syntax   | Library | For syntax and to ensure a responsive website.             |
